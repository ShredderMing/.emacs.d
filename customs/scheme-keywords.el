...
(put 'foreign-alloc 'scheme-indent-function 0)
(put 'foreign-procedure 'scheme-indent-function 1)
(put 'ftype-ref 'scheme-indent-function 1)
(put 'function 'scheme-indent-function 0)
  ...
  (when (featurep 'company)
    (defun company-scheme-keywords
      ...
      (cl-case command
        ...
        (cl-prefix (and (eq major-mode 'scheme-mode) (company-grab-symbol)))
        (cl-candidates (cl-remove-if-not
			(lambda (candidate)
